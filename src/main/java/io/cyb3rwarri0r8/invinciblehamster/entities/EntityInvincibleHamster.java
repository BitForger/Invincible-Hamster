...
public class EntityInvincibleHamster extends EntityTameable
{
    ...
    public EntityInvincibleHamster(World par1World)
    {
        ...
        this.tasks.addTask(2, new EntityAINomCages(this));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (this.isTamed())
        {
            if (par1EntityPlayer.getCommandSenderName().equalsIgnoreCase(this.func_152113_b()) && !this.worldObj.isRemote && !this.isBreedingItem(var2))
            {
    ...
    public EntityAgeable createChild(EntityAgeable var1)
    {
        ...
        if (this.isTamed())
        {
            entityhamster.func_152115_b(this.func_152113_b());
