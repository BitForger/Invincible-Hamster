package io.cyb3rwarri0r8.invinciblehamster.client.rendering;
...
public class ModelInvincibleHamster extends ModelBase
{

    /**
     * main box for the hamster head
     */
    public ModelRenderer hamsterHeadMain;
     ...
     * Hamster's first leg
     */
    public ModelRenderer hamsterLeg1;

    /**
     * Hamster's second leg
     */
    public ModelRenderer hamsterLeg2;

    /**
     * Hamster's third leg
     */
    public ModelRenderer hamsterLeg3;

    /**
     * Hamster's fourth leg
     */
    public ModelRenderer hamsterLeg4;

    /**
     * The hamster's mane
     */
    ModelRenderer hamsterMane;

    public ModelInvincibleHamster()
    {
        float f = 0.0F;
        float f1 = 13.5F;
    ...
    {
        EntityInvincibleHamster entityhamster = (EntityInvincibleHamster) par1EntityLiving;
